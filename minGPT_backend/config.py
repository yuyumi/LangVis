...
def getConfig():
    ...
    parser.add_argument('--saliency',  default=True, action=argparse.BooleanOptionalAction,
    ...
    parser.add_argument('--attn_pairs', default=True, action=argparse.BooleanOptionalAction,
